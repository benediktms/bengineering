...
export type Unnamed_1_Query = { allMdx: { nodes: Array<{ id: string, body: string, slug?: string | null | undefined, frontmatter?: { date?: any | null | undefined, title: string } | null | undefined }> } };
